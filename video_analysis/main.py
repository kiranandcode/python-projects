    ...
    def run(self):
        ...
        while True:
            ...
            if len(self.tracks) > 0:
                ...
                if dt.process_frame(self.frame_idx, frame) > 0.5:
                    new_scene = True
                ...
                draw_str(vis, (20, 20), 'track count: %d, d: %d, p0-pr: %s - current time: %s' % (
                len(self.tracks), d.sum(), str((p0 - p0r).mean()), self.current_msec()))
